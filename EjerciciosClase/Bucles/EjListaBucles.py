...
for n in range(0,len(lista8)):
    if n % 2 == 0:
        ...
        sumaImpar8 += lista8[n]
print(F"Ej08: La suma de los números situados en las posiciones impares de la lista {lista8} es: {sumaPar8}")
print(F"Ej08: La suma de los números situados en las las posiciones pares de la lista {lista8} es: {sumaImpar8}")
